  ...
  return (
    <div className="intro" id="intro">
      <div className="intro-wrapper">
        ...
        <p>
          I'm a software engineer specialized in backend development, working on my frontend skills (it's a work in progress).<br></br>Currently, I'm focused on building REST API integrations for <a href="https://www.synergyscience.com/" className = "company-name">Synergy Science</a>.
        </p>
